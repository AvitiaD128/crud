                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url; ?>CRUDP/insertarDatos.php" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="causasen" name="causasen" placeholder="Ingrese" required>
                            </div>
                            <div class="mb-3">
                                <label for="descripcion" class="form-label">descripcion</label>
                                <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Ingrese" required>
                            </div>
                            <div class="mb-3">
                                <label for="noCaso" class="form-label">noCaso</label>
                                <input type="text" class="form-control" id="noCaso" name="noCaso" placeholder="Ingrese" required>
                            </div>
                            <div class="mb-3">
                                <label for="sentencia" class="form-label">sentencia</label>
                                <input type="text" class="form-control" id="sentencia" name="sentencia" placeholder="Ingrese" required>
                            </div>
                            <div class="mb-3">
                                <label for="tSentencia" class="form-label">tSentencia</label>
                                <input type="text" class="form-control" id="tSentencia" name="tSentencia" placeholder="Ingrese" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="noCelda" name="noCelda" placeholder="Ingrese" required>
                            </div>
