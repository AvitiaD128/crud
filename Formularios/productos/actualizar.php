    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center">ACTUALIZAR SENTENCIA</h5>
                        <form action="<?php echo base_url; ?>CRUDP/editarDatos.php" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="causasen" name="causasen" placeholder="Ingrese" value="<?php echo $row['causasen'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="descripcion" class="form-label">descripcion</label>
                                <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Ingrese" value="<?php echo $row['descripcion'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="noCaso" class="form-label">noCaso</label>
                                <input type="text" class="form-control" id="noCaso" name="noCaso" placeholder="Ingrese" value="<?php echo $row['noCaso'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="sentencia" class="form-label">sentencia</label>
                                <input type="text" class="form-control" id="sentencia" name="sentencia" placeholder="Ingrese" value="<?php echo $row['sentencia'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="tSentencia" class="form-label">tSentencia</label>
                                <input type="text" class="form-control" id="tSentencia" name="tSentencia" placeholder=""Ingrese" value="<?php echo $row['tSentencia'] ?>">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="noCelda" name="noCelda" placeholder="Ingrese" value="<?php echo $row['noCelda'] ?>">
                            </div>
